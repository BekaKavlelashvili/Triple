...
namespace Triple.Infrastructure.Migrations
{
    ...
    partial class TripleDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Triple.Domain.Aggregates.Chat.Chat", b =>
                {
                    b.OwnsMany("Triple.Domain.Aggregates.Chat.Chat.Messages#Triple.Domain.Aggregates.Chat.Message", "Messages", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                    ...
                    b.OwnsMany("Triple.Domain.Aggregates.Chat.Chat.Users#Triple.Domain.Aggregates.Chat.ChatUsers", "Users", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("Triple.Domain.Aggregates.Pack.Pack", b =>
                {
                    b.OwnsMany("Triple.Domain.Aggregates.Pack.Pack.Photos#Triple.Domain.Aggregates.Pack.PackPhoto", "Photos", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                    ...
                    b.OwnsMany("Triple.Domain.Aggregates.Pack.Pack.Reviews#Triple.Domain.Aggregates.Pack.Review", "Reviews", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.ToTable("PackReviews", (string)null);
            ...
            modelBuilder.Entity("Triple.Infrastructure.Identity.PermissionGroup", b =>
                {
                    b.OwnsMany("Triple.Infrastructure.Identity.PermissionGroup.Permissions#Triple.Infrastructure.Identity.Permission", "Permissions", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
