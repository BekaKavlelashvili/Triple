...
{
    public class SearchCurrentOrdersForOrganisationQueryHandler : IRequestHandler<SearchCurrentOrdersForOrganisationQuery, QueryResultOfList<OrderDto>>
    {
        private TripleDbContext _dbContext;
        private readonly IUserService _userService;

        public SearchCurrentOrdersForOrganisationQueryHandler(TripleDbContext dbContext, IUserService userService)
        {
            _dbContext = dbContext;
            _userService = userService;
        }

        public async Task<QueryResultOfList<OrderDto>> Handle(SearchCurrentOrdersForOrganisationQuery request, CancellationToken cancellationToken)
        {
