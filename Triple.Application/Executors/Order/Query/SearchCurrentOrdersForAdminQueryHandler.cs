...
{
    public class SearchCurrentOrdersForAdminQueryHandler : IRequestHandler<SearchCurrentOrdersForAdminQuery, QueryResultOfList<OrderForAdminDto>>
    {
        private TripleDbContext _dbContext;

        public SearchCurrentOrdersForAdminQueryHandler(TripleDbContext dbContext)
        {
            _dbContext = dbContext;
        }

        public async Task<QueryResultOfList<OrderForAdminDto>> Handle(SearchCurrentOrdersForAdminQuery request, CancellationToken cancellationToken)
        {
